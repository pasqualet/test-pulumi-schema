...
export class Password extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'test-pulumi-schema:index:Password';
     ...
     */
    public /*out*/ readonly length!: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, args?: PasswordArgs, opts?: pulumi.ComponentResourceOptions) {
        ...
        super(Password.__pulumiType, name, resourceInputs, opts, true /*remote*/);
    }
}
